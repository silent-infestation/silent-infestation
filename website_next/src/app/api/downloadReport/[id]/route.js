...
export async function GET(req, { params }) {
  ...
  try {
    ...
    doc.setFontSize(14);
    doc.text(`Scan ID: ${scan.id}`, pageWidth / 2, pageHeight / 2 - 10, { align: "center" });
    doc.text(`User ID: ${userId}`, pageWidth / 2, pageHeight / 2 + 2, { align: "center" });
    ...
    doc.setFont("courier", "normal");
    doc.setFontSize(12);
    doc.text("Generated by SilentInfestation3™", pageWidth / 2, pageHeight - 30, { align: "center" });
    footer();
    pageNumber++;
